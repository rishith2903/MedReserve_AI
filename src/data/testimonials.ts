...
export const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment: "Dr. Kumar is an exceptional cardiologist. His thorough examination and clear explanation of my condition gave me great confidence. The treatment plan he provided has significantly improved my heart health.",
    date: "2024-07-15",
    verified: true
  },
  {
    ...
    specialty: "Cardiology",
    rating: 5,
    comment: "Outstanding care and professionalism. Dr. Sharma took the time to explain every aspect of my cardiac procedure. I felt completely at ease throughout the entire process.",
    date: "2024-07-10",
    verified: true
  },
  {
    ...
    specialty: "Neurology",
    rating: 4,
    comment: "Dr. Miller's expertise in neurology is remarkable. He diagnosed my condition quickly and provided effective treatment. Very satisfied with the care received.",
    date: "2024-07-08",
    verified: true
  },
  {
    ...
    rating: 5,
    comment: "Excellent dermatologist! Dr. Anderson resolved my skin condition that I had been struggling with for months. Her approach is both professional and caring.",
    date: "2024-07-05",
    verified: true
  },
  {
    ...
    rating: 5,
    comment: "Dr. Taylor performed my knee surgery with incredible skill. The recovery was smooth and I'm back to my normal activities. Highly recommend!",
    date: "2024-07-02",
    verified: true
  },
  {
    ...
    rating: 5,
    comment: "Dr. Garcia is wonderful with children. My daughter feels comfortable during visits and Dr. Garcia always takes time to address all our concerns.",
    date: "2024-06-28",
    verified: true
  },
  {
...
export const getTestimonialsByDoctor = (doctorName: string): Testimonial[] => {
  return testimonials.filter(t => t.doctorName === doctorName);
};

export const getTestimonialsBySpecialty = (specialty: string): Testimonial[] => {
  return testimonials.filter(t => t.specialty === specialty);
};

export const getAverageRating = (doctorName?: string, specialty?: string): number => {
...
export const getTotalReviews = (doctorName?: string, specialty?: string): number => {
  let filteredTestimonials = testimonials;
